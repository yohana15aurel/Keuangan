...
public class Choose_pengeluaran extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_pengeluaran);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        x = position;
        if (x == 2) {
            startActivity(new Intent(getApplicationContext(), Choose_pemasukan.class));
            overridePendingTransition(0, 0);
        }
    }
